        ...
        <div class="g-fullheight--md js__parallax-window" style="background: url(img/1920x1080/02.jpg) 50% 0 no-repeat fixed;">
            <div class="g-container--md g-text-center--xs g-ver-center--md g-padding-y-150--xs g-padding-y-0--md">
                <div class="g-margin-b-60--xs hidden-xs">
                    <h2 style="color:white">Blog Form</h2>

<form action="blog_upload.php" method="post" enctype="multipart/form-data">
  <div class="container" style="width: 924px !important;"> 
    <input type="text" placeholder="Enter Blog Heading" name="heading" required>
 
    <input type="text" placeholder="Enter Side Heading" name="side_heading" >
    <textarea class="form-control rounded-0"name="content"  rows="7" placeholder="Please Enter The Content"></textarea>
