...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <title>Apple Tree Event - About</title>
    ...
    <body>
                ...
                <nav class="s-header__nav js__scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="list-unstyled s-header__nav-menu">
                            ...
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" onclick="location.href='blog-list'">Edit/Delete</a></li>
        ...
        <div class="g-fullheight--md js__parallax-window" style="background: url(img/1920x1080/02.jpg) 50% 0 no-repeat fixed;">
            <div class="g-container--md g-text-center--xs g-ver-center--md g-padding-y-150--xs g-padding-y-0--md">
                <div class="g-margin-b-60--xs hidden-xs">
                    <h2 style="color:white">Blog Edit Form</h2>
<?php
        $id=$_GET['id'];
...
<form action="blog_update.php" method="post" enctype="multipart/form-data">
  <div class="container" style="width: 924px !important;"> 
    <input type="hidden" name="id" value="<?=$id?>">
    <input type="text" placeholder="Enter Blog Heading" name="heading" value="<?=$heading?>"required>
    
    <input type="text" placeholder="Enter Side Heading" name="side_heading" value="<?=$side_heading?>" >
    <textarea class="form-control rounded-0"name="content"  rows="7" placeholder="Please Enter The Content" ><?=$content?></textarea>
<label> <font color=white>Must 400X400 Uploading Image Size</font></label>
    <input type="file" name="blog_image"  required>
        
    <button type="submit" name="blog_submit">submit</button>
  </div>
