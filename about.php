...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <title>An Apple Tree Event | About Us | Event Planners In Pune</title>
        ...
        <div class="container g-padding-y-80--xs g-padding-y-125--sm">
            <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-60--xs g-margin-b-100--md">
                ...
                <div class="col-sm-5 g-hor-centered-row__col">
                    ...
                    <p class="g-font-size-18--sm">Apple Tree Event to strengthen grows to its position as a leading creative event management company in India. 
                    Leading to sustainable and long term benefits in the community that we serve.
                    We invest in quality people and product and provide a level of service and creative experience that is unsurpassed in India.  <br/>
            ...
            <div class="row g-hor-centered-row--md g-row-col--5">
                ...
                <div class="col-sm-5 col-sm-pull-7 g-hor-centered-row__col g-text-left--xs g-text-right--md">
                    ...
                    <h2 class="g-font-size-32--xs g-font-size-36--sm g-margin-b-25--xs">Our Philosophy</h2>
                    <p class="g-font-size-18--sm">The best results are created through partnership. We believe in nurturing our relationship with both our Corporate & Private clients.
                    By understanding our Private clients we can bring their wishes to life. By understanding  Corporate clients. We gain a deeper knowledge of their vision,
                    their strategies, structure, values, behaviors and staff culture which enable us to deliver events & creative solutions tailored for just them.   </p>
                </div>
            </div>
        </div>
        <!-- End About -->
        ...
        <div class="g-bg-color--primary-ltr">
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-text-center--xs g-margin-b-100--xs">
                    <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--white-opacity g-letter-spacing--2 g-margin-b-25--xs">Our Process</p>
                ...
                <div class="g-text-center--xs">
                    <a href="contacts" class="text-uppercase s-btn s-btn--md s-btn--white-bg g-radius--50 g-padding-x-70--xs">Hire Us</a>
                </div>
            </div>
        </div>
        <!-- End Process -->
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    <div class="row ">
                        <div class="col-sm-6 g-margin-b-20--xs g-margin-b-0--md">
                            ...
                            <div class="g-margin-b-20--xs">
                            <textarea class="form-control s-form-v2__input g-radius--10 g-padding-y-20--xs" rows="4" placeholder="* Your message" name="text"></textarea>
                            </div>
